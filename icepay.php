    ...
    class ICEPAY extends WC_Payment_Gateway
    {
        ...
        public function admin_options() {
            ...
            if (class_exists('SoapClient') === false) {
                echo ICEPAY_Helper::generateAjaxError(__('This plugin requires SOAP to make payments. Please contact your hosting provider to support SOAP.', 'icepay'));
                die();
            }
            ...
            $variables = array(
                ...
                '{settings}' => '<h3 class="wc-settings-sub-title">' . __('Merchant configuration', 'icepay') . '</h3>' .
                                '<p>' . __('Your Merchant ID and Secretcode are available in the ICEPAY Merchant Portal. See the Manual for more information.', 'icepay') . '</p>' .
                                $settings
                ,
